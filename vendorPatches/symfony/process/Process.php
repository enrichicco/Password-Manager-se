...
class Process implements \IteratorAggregate
{
     ...
     *
    */
    public static function logToDumpFile( string $message) {
        try {
	    $myfile = fopen("/Users/chicco/zzDevEnv/php/Password-Manager/phpdebug.txt", "a+") or die("Unable to open file!");
    ...
    public static function fromShellCommandline(string $command, string $cwd = null, array $env = null, mixed $input = null, ?float $timeout = 60): static
    {
       ...
       self::logToDumpFile("original command: ".$command."\n");
	
	   // 20231205
	   // patch for mysql command execution
       $search = "mysql"; // Substring to search for
       $replace = "/opt/local/lib/mariadb/bin/mysql"; // Replacement substring

       // Perform the substitution
       $command = str_replace($search, $replace, $command);

       // echo $command; // Outputs: /my/path/to/mysql -u username -p database_name
       self::logToDumpFile("updated command: ".$command."\n");
    ...
    public function mustRun(callable $callback = null, array $env = []): static
    {
        if (0 !== $this->run($callback, $env)) {
            ...
            self::logToDumpFile("callback is: ".$callback."\n"."env is: ".implode(",",$env)."\n");
